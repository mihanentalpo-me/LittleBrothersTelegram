...
static const char *NativeByteBufferClassPathName = "org/littlebrother/telegram/tgnet/NativeByteBuffer";
...
static const char *ConnectionsManagerClassPathName = "org/littlebrother/telegram/tgnet/ConnectionsManager";
static JNINativeMethod ConnectionsManagerMethods[] = {
        ...
        {"native_checkProxy", "(ILjava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Lorg/littlebrother/telegram/tgnet/RequestTimeDelegate;)J", (void *) checkProxy},
...
extern "C" int registerNativeTgNetFunctions(JavaVM *vm, JNIEnv *env) {
    ...
    jclass_RequestTimeDelegate = (jclass) env->NewGlobalRef(env->FindClass("org/littlebrother/telegram/tgnet/RequestTimeDelegate"));
    ...
    jclass_ConnectionsManager = (jclass) env->NewGlobalRef(env->FindClass("org/littlebrother/telegram/tgnet/ConnectionsManager"));
