...
import static org.littlebrother.telegram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_ACCOUNTS;
import static org.littlebrother.telegram.ui.Components.Premium.LimitReachedBottomSheet.TYPE_BOOSTS_FOR_USERS;
...
import org.littlebrother.telegram.messenger.AutoDeleteMediaTask;
import org.littlebrother.telegram.messenger.BackupAgent;
...
import org.littlebrother.telegram.messenger.ChannelBoostsController;
import org.littlebrother.telegram.messenger.ChatObject;
import org.littlebrother.telegram.messenger.ContactsController;
import org.littlebrother.telegram.messenger.ContactsLoadingObserver;
...
import org.littlebrother.telegram.messenger.FingerprintController;
import org.littlebrother.telegram.messenger.FlagSecureReason;
import org.littlebrother.telegram.messenger.GenericProvider;
...
import org.littlebrother.telegram.messenger.OpenAttachedMenuBotReceiver;
import org.littlebrother.telegram.messenger.PushListenerController;
...
import org.littlebrother.telegram.messenger.SharedPrefsHelper;
import org.littlebrother.telegram.messenger.TopicsController;
...
import org.littlebrother.telegram.messenger.voip.VideoCapturerDevice;
import org.littlebrother.telegram.messenger.voip.VoIPPendingCall;
import org.littlebrother.telegram.messenger.voip.VoIPPreNotificationService;
import org.littlebrother.telegram.messenger.voip.VoIPService;
...
import org.littlebrother.telegram.ui.ActionBar.ActionBarLayout;
import org.littlebrother.telegram.ui.ActionBar.AlertDialog;
import org.littlebrother.telegram.ui.ActionBar.BaseFragment;
import org.littlebrother.telegram.ui.ActionBar.BottomSheetTabs;
import org.littlebrother.telegram.ui.ActionBar.BottomSheetTabsOverlay;
...
import org.littlebrother.telegram.ui.Cells.ChatMessageCell;
...
import org.littlebrother.telegram.ui.Components.AppIconBulletinLayout;
import org.littlebrother.telegram.ui.Components.AttachBotIntroTopView;
import org.littlebrother.telegram.ui.Components.AudioPlayerAlert;
import org.littlebrother.telegram.ui.Components.BatteryDrawable;
import org.littlebrother.telegram.ui.Components.BlockingUpdateView;
...
import org.littlebrother.telegram.ui.Components.Easings;
import org.littlebrother.telegram.ui.Components.EmbedBottomSheet;
...
import org.littlebrother.telegram.ui.Components.GroupCallPip;
...
import org.littlebrother.telegram.ui.Components.PasscodeView;
import org.littlebrother.telegram.ui.Components.PasscodeViewDialog;
import org.littlebrother.telegram.ui.Components.PhonebookShareAlert;
import org.littlebrother.telegram.ui.Components.PipRoundVideoView;
import org.littlebrother.telegram.ui.Components.Premium.LimitReachedBottomSheet;
import org.littlebrother.telegram.ui.Components.Premium.boosts.BoostPagerBottomSheet;
...
import org.littlebrother.telegram.ui.Components.SearchTagsList;
import org.littlebrother.telegram.ui.Components.SharingLocationsAlert;
import org.littlebrother.telegram.ui.Components.SideMenultItemAnimator;
import org.littlebrother.telegram.ui.Components.SizeNotifierFrameLayout;
import org.littlebrother.telegram.ui.Components.StickerSetBulletinLayout;
import org.littlebrother.telegram.ui.Components.StickersAlert;
import org.littlebrother.telegram.ui.Components.TermsOfServiceView;
import org.littlebrother.telegram.ui.Components.ThemeEditorView;
import org.littlebrother.telegram.ui.Components.UndoView;
import org.littlebrother.telegram.ui.Components.spoilers.SpoilerEffect2;
import org.littlebrother.telegram.ui.Components.voip.VoIPHelper;
import org.littlebrother.telegram.ui.Stars.ISuperRipple;
import org.littlebrother.telegram.ui.Stars.StarsController;
import org.littlebrother.telegram.ui.Stars.SuperRipple;
import org.littlebrother.telegram.ui.Stars.SuperRippleFallback;
...
import org.littlebrother.telegram.ui.bots.WebViewRequestProps;
...
//            dismissAllWeb();
        ...
        if ((flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
            if (intent != null && intent.getAction() != null && !restore) {
                ...
                } else if ("org.littlebrother.telegram.messenger.CREATE_STICKER_PACK".equals(intent.getAction())) {
                    try {
...
//                                                storyId = Utilities.parseInt(data.getQueryParameter("story"));
                                ...
                                try (Cursor cursor = getContentResolver().query(intent.getData(), null, null, null, null)) {
                                    if (cursor != null) {
                                        if (cursor.moveToFirst()) {
                                            ...
                                            if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.littlebrother.telegram.messenger.android.call")) {
                                                audioCallUser = true;
                                            } else if (TextUtils.equals(mimeType, "vnd.android.cursor.item/vnd.org.littlebrother.telegram.messenger.android.call.video")) {
                                                videoCallUser = true;
                                            }
                                        }
                                    }
                ...
                } else if (intent.getAction().equals("org.littlebrother.telegram.messenger.OPEN_ACCOUNT")) {
                    open_settings = 1;
