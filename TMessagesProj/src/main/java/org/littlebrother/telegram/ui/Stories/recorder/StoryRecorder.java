...
import static org.littlebrother.telegram.messenger.AndroidUtilities.touchSlop;
...
import org.littlebrother.telegram.messenger.camera.CameraController;
...
import org.littlebrother.telegram.ui.Cells.ShareDialogCell;
...
import org.littlebrother.telegram.ui.Components.FilterShaders;
import org.littlebrother.telegram.ui.Components.GestureDetectorFixDoubleTap;
...
import org.littlebrother.telegram.ui.Components.PhotoFilterBlurControl;
import org.littlebrother.telegram.ui.Components.PhotoFilterCurvesControl;
import org.littlebrother.telegram.ui.Components.PhotoFilterView;
...
import org.littlebrother.telegram.ui.Components.ThanosEffect;
import org.littlebrother.telegram.ui.Components.URLSpanUserMention;
import org.littlebrother.telegram.ui.Components.VideoEditTextureView;
import org.littlebrother.telegram.ui.Components.WaveDrawable;
import org.littlebrother.telegram.ui.Components.ZoomControlView;
...
import org.littlebrother.telegram.ui.Stories.PeerStoriesView;
import org.littlebrother.telegram.ui.Stories.StoriesController;
import org.littlebrother.telegram.ui.Stories.StoryViewer;
import org.littlebrother.telegram.ui.Stories.StoryWaveEffectView;
            ...
            protected boolean ignoreTouches(float x, float y) {
                ...
                for (int i = 0; i < paintView.entitiesView.getChildCount(); ++i) {
                    ...
                    if (view instanceof EntityView) {
                        org.littlebrother.telegram.ui.Components.Rect rect = ((EntityView) view).getSelectionBounds();
...
//                    setAwakeLock(false);
    ...
    public boolean onBackPressed() {
        ...
        if (captionEdit.onBackPressed()) {
            ...
            if (paintView != null && paintView.onBackPressed()) {
                return false;
            } else if (botId == 0 && (fromGallery && (paintView == null || !paintView.hasChanges()) && (outputEntry == null || outputEntry.filterFile == null) || !previewButtons.isShareEnabled()) && (outputEntry == null || !outputEntry.isEdit || !outputEntry.isRepost && !outputEntry.isRepostMessage) && !isReposting) {
    ...
    public void navigateTo(int page, boolean animated) {
        ...
        if (animated) {
            ...
            animators.add(ObjectAnimator.ofFloat(previewView, View.ALPHA, page == PAGE_PREVIEW || page == PAGE_COVER ? 1 : 0));
...
//            animators.add(ObjectAnimator.ofFloat(privacySelector, View.ALPHA, page == PAGE_PREVIEW ? 1f : 0));
            ...
            previewView.setAlpha(page == PAGE_PREVIEW || page == PAGE_COVER ? 1f : 0);
