...
import org.littlebrother.telegram.messenger.MrzRecognizer;
...
import org.littlebrother.telegram.messenger.SecureDocument;
import org.littlebrother.telegram.messenger.SecureDocumentKey;
...
import org.littlebrother.telegram.ui.Cells.TextDetailSettingsCell;
...
import org.littlebrother.telegram.ui.Components.HintEditText;
    ...
    private void createIdentityInterface(final Context context) {
        ...
        if (currentDocumentsType != null) {
            ...
            scanDocumentCell.setOnClickListener(v -> {
                ...
                CameraScanActivity fragment = new CameraScanActivity(org.littlebrother.telegram.ui.CameraScanActivity.TYPE_MRZ);
