...
import static org.littlebrother.telegram.messenger.ContactsController.PRIVACY_RULES_TYPE_ADDED_BY_PHONE;
...
import org.littlebrother.telegram.PhoneFormat.PhoneFormat;
import org.littlebrother.telegram.messenger.AccountInstance;
...
import org.littlebrother.telegram.messenger.AuthTokensHelper;
import org.littlebrother.telegram.messenger.BillingController;
import org.littlebrother.telegram.messenger.BirthdayController;
import org.littlebrother.telegram.messenger.BuildVars;
import org.littlebrother.telegram.messenger.ChatObject;
import org.littlebrother.telegram.messenger.ChatThemeController;
import org.littlebrother.telegram.messenger.ContactsController;
import org.littlebrother.telegram.messenger.DialogObject;
...
import org.littlebrother.telegram.messenger.FlagSecureReason;
...
import org.littlebrother.telegram.messenger.LanguageDetector;
import org.littlebrother.telegram.messenger.LiteMode;
import org.littlebrother.telegram.messenger.LocaleController;
import org.littlebrother.telegram.messenger.MediaController;
...
import org.littlebrother.telegram.messenger.MessagesStorage;
import org.littlebrother.telegram.messenger.NotificationCenter;
import org.littlebrother.telegram.messenger.NotificationsController;
import org.littlebrother.telegram.messenger.R;
import org.littlebrother.telegram.messenger.SendMessagesHelper;
...
import org.littlebrother.telegram.messenger.UserObject;
...
import org.littlebrother.telegram.tgnet.TLObject;
import org.littlebrother.telegram.tgnet.TLRPC;
import org.littlebrother.telegram.tgnet.tl.TL_bots;
import org.littlebrother.telegram.tgnet.tl.TL_fragment;
import org.littlebrother.telegram.tgnet.tl.TL_stories;
import org.littlebrother.telegram.ui.ActionBar.ActionBar;
import org.littlebrother.telegram.ui.ActionBar.ActionBarMenu;
import org.littlebrother.telegram.ui.ActionBar.ActionBarMenuItem;
import org.littlebrother.telegram.ui.ActionBar.ActionBarMenuSubItem;
import org.littlebrother.telegram.ui.ActionBar.ActionBarPopupWindow;
import org.littlebrother.telegram.ui.ActionBar.AlertDialog;
import org.littlebrother.telegram.ui.ActionBar.BackDrawable;
...
import org.littlebrother.telegram.ui.ActionBar.OKLCH;
import org.littlebrother.telegram.ui.ActionBar.SimpleTextView;
import org.littlebrother.telegram.ui.ActionBar.Theme;
import org.littlebrother.telegram.ui.ActionBar.ThemeDescription;
import org.littlebrother.telegram.ui.Business.OpeningHoursActivity;
import org.littlebrother.telegram.ui.Business.ProfileHoursCell;
import org.littlebrother.telegram.ui.Business.ProfileLocationCell;
import org.littlebrother.telegram.ui.Cells.AboutLinkCell;
import org.littlebrother.telegram.ui.Cells.CheckBoxCell;
import org.littlebrother.telegram.ui.Cells.DividerCell;
import org.littlebrother.telegram.ui.Cells.DrawerProfileCell;
import org.littlebrother.telegram.ui.Cells.GraySectionCell;
import org.littlebrother.telegram.ui.Cells.HeaderCell;
import org.littlebrother.telegram.ui.Cells.NotificationsCheckCell;
import org.littlebrother.telegram.ui.Cells.ProfileChannelCell;
import org.littlebrother.telegram.ui.Cells.SettingsSearchCell;
import org.littlebrother.telegram.ui.Cells.SettingsSuggestionCell;
import org.littlebrother.telegram.ui.Cells.ShadowSectionCell;
import org.littlebrother.telegram.ui.Cells.TextCell;
import org.littlebrother.telegram.ui.Cells.TextCheckCell;
import org.littlebrother.telegram.ui.Cells.TextDetailCell;
import org.littlebrother.telegram.ui.Cells.TextInfoPrivacyCell;
import org.littlebrother.telegram.ui.Cells.UserCell;
import org.littlebrother.telegram.ui.Components.AlertsCreator;
import org.littlebrother.telegram.ui.Components.AnimatedColor;
import org.littlebrother.telegram.ui.Components.AnimatedEmojiDrawable;
import org.littlebrother.telegram.ui.Components.AnimatedFileDrawable;
import org.littlebrother.telegram.ui.Components.AnimatedFloat;
import org.littlebrother.telegram.ui.Components.AnimatedTextView;
import org.littlebrother.telegram.ui.Components.AnimationProperties;
import org.littlebrother.telegram.ui.Components.AudioPlayerAlert;
import org.littlebrother.telegram.ui.Components.AutoDeletePopupWrapper;
import org.littlebrother.telegram.ui.Components.AvatarDrawable;
import org.littlebrother.telegram.ui.Components.BackButtonMenu;
import org.littlebrother.telegram.ui.Components.BackupImageView;
import org.littlebrother.telegram.ui.Components.Bulletin;
import org.littlebrother.telegram.ui.Components.BulletinFactory;
import org.littlebrother.telegram.ui.Components.ButtonBounce;
import org.littlebrother.telegram.ui.Components.CanvasButton;
import org.littlebrother.telegram.ui.Components.ChatActivityInterface;
import org.littlebrother.telegram.ui.Components.ChatAvatarContainer;
import org.littlebrother.telegram.ui.Components.ChatNotificationsPopupWrapper;
import org.littlebrother.telegram.ui.Components.ColoredImageSpan;
import org.littlebrother.telegram.ui.Components.CombinedDrawable;
import org.littlebrother.telegram.ui.Components.CrossfadeDrawable;
import org.littlebrother.telegram.ui.Components.CubicBezierInterpolator;
import org.littlebrother.telegram.ui.Components.DotDividerSpan;
import org.littlebrother.telegram.ui.Components.EmojiPacksAlert;
import org.littlebrother.telegram.ui.Components.EmptyStubSpan;
import org.littlebrother.telegram.ui.Components.FloatingDebug.FloatingDebugController;
import org.littlebrother.telegram.ui.Components.Forum.ForumUtilities;
import org.littlebrother.telegram.ui.Components.FragmentContextView;
import org.littlebrother.telegram.ui.Components.HintView;
import org.littlebrother.telegram.ui.Components.IdenticonDrawable;
import org.littlebrother.telegram.ui.Components.ImageUpdater;
import org.littlebrother.telegram.ui.Components.InstantCameraView;
import org.littlebrother.telegram.ui.Components.ItemOptions;
import org.littlebrother.telegram.ui.Components.JoinGroupAlert;
...
import org.littlebrother.telegram.ui.Components.MediaActivity;
import org.littlebrother.telegram.ui.Components.MessagePrivateSeenView;
import org.littlebrother.telegram.ui.Components.Paint.PersistColorPalette;
import org.littlebrother.telegram.ui.Components.Premium.LimitReachedBottomSheet;
import org.littlebrother.telegram.ui.Components.Premium.PremiumFeatureBottomSheet;
import org.littlebrother.telegram.ui.Components.Premium.PremiumGradient;
import org.littlebrother.telegram.ui.Components.Premium.PremiumPreviewBottomSheet;
import org.littlebrother.telegram.ui.Components.Premium.ProfilePremiumCell;
import org.littlebrother.telegram.ui.Components.Premium.boosts.UserSelectorBottomSheet;
import org.littlebrother.telegram.ui.Components.ProfileGalleryView;
import org.littlebrother.telegram.ui.Components.RLottieDrawable;
import org.littlebrother.telegram.ui.Components.RLottieImageView;
import org.littlebrother.telegram.ui.Components.RadialProgressView;
import org.littlebrother.telegram.ui.Components.Reactions.ReactionsLayoutInBubble;
import org.littlebrother.telegram.ui.Components.RecyclerListView;
import org.littlebrother.telegram.ui.Components.ScamDrawable;
import org.littlebrother.telegram.ui.Components.ShareAlert;
import org.littlebrother.telegram.ui.Components.SharedMediaLayout;
import org.littlebrother.telegram.ui.Components.SizeNotifierFrameLayout;
import org.littlebrother.telegram.ui.Components.StickerEmptyView;
import org.littlebrother.telegram.ui.Components.TimerDrawable;
import org.littlebrother.telegram.ui.Components.TranslateAlert2;
import org.littlebrother.telegram.ui.Components.TypefaceSpan;
import org.littlebrother.telegram.ui.Components.UndoView;
import org.littlebrother.telegram.ui.Components.VectorAvatarThumbDrawable;
import org.littlebrother.telegram.ui.Components.voip.VoIPHelper;
import org.littlebrother.telegram.ui.Gifts.GiftSheet;
import org.littlebrother.telegram.ui.Stars.BotStarsActivity;
import org.littlebrother.telegram.ui.Stars.BotStarsController;
import org.littlebrother.telegram.ui.Stars.StarsController;
import org.littlebrother.telegram.ui.Stars.StarsIntroActivity;
import org.littlebrother.telegram.ui.Stories.ProfileStoriesView;
import org.littlebrother.telegram.ui.Stories.StoriesController;
import org.littlebrother.telegram.ui.Stories.StoriesListPlaceProvider;
import org.littlebrother.telegram.ui.Stories.StoryViewer;
import org.littlebrother.telegram.ui.Stories.recorder.ButtonWithCounterView;
import org.littlebrother.telegram.ui.Stories.recorder.DualCameraView;
import org.littlebrother.telegram.ui.Stories.recorder.StoryRecorder;
import org.littlebrother.telegram.ui.bots.BotBiometry;
import org.littlebrother.telegram.ui.bots.BotWebViewAttachedSheet;
    ...
    private boolean editRow(View view, int position) {
        ...
        if (position == bizHoursRow) {
            ...
            itemOptions.add(R.drawable.msg_edit, getString(R.string.ProfileLocationEdit), () -> {
                presentFragment(new org.littlebrother.telegram.ui.Business.LocationActivity());
            });
